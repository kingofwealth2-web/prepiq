...
const s = {
  ...
  heroLeft: {},
  heroLabel: { fontSize: '0.68rem', fontWeight: '600', letterSpacing: '0.12em', color: 'var(--ink-muted)', textTransform: 'uppercase', marginBottom: '8px' },
  heroGrade: { fontFamily: 'var(--ff)', fontSize: '3.5rem', fontWeight: '700', lineHeight: 1, marginBottom: '8px' },
  heroSub: { fontSize: '0.84rem', color: 'var(--ink-muted)' },
  ...
  btnPrimary: { flex: 1, padding: '13px', background: 'var(--surface-solid)', border: 'none', borderRadius: 'var(--r-sm)', color: 'var(--ink)', fontWeight: '600', fontSize: '0.88rem', cursor: 'pointer', fontFamily: 'var(--ff)' },
