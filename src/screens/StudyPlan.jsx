...
const s = {
  ...
  taskCard: { display: 'flex', alignItems: 'center', gap: '14px', background: '#fff', border: '1px solid var(--border)', borderRadius: 'var(--r-md)', padding: '15px', transition: 'all 0.2s', boxShadow: 'var(--shadow-sm)' },
  ...
  weekCard: { background: '#fff', border: '1px solid var(--border)', borderRadius: 'var(--r-lg)', padding: '20px', boxShadow: 'var(--shadow-sm)' },
  ...
  dayCell: { display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '6px', padding: '10px 0', borderRadius: 'var(--r-sm)', background: 'var(--cream)' },
