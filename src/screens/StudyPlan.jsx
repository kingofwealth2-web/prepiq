              ...
              <div style={s.weakList}>
                {weakTopics.map((t, i) => (
                  <div key={i} style={s.weakItem}>
                    ...
                    <div style={s.weakBar}>
                      <div style={{ ...s.weakFill, width: `${t.score}%`, background: t.score < 50 ? 'var(--red)' : 'var(--gold)' }} />
                    </div>
...
const s = {
  ...
  weakCard: { background: 'var(--forest-mid)', borderRadius: 'var(--r-xl)', padding: '22px', marginBottom: '14px', position: 'relative', overflow: 'hidden' },
  ...
  weakTitle: { fontSize: '0.92rem', fontWeight: '700', color: '#F7F3EE', marginBottom: '2px', fontFamily: 'var(--ff-serif)' },
  ...
  noDataBanner: { background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 'var(--r-lg)', padding: '16px', display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '14px', boxShadow: 'var(--shadow-sm)' },
  ...
  btnSmall: { padding: '8px 14px', background: 'var(--forest-mid)', border: 'none', borderRadius: 'var(--r-sm)', color: '#F7F3EE', fontWeight: '600', fontSize: '0.78rem', cursor: 'pointer', fontFamily: 'var(--ff-sans)', flexShrink: 0 },
  ...
  taskCard: { display: 'flex', alignItems: 'center', gap: '14px', background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 'var(--r-md)', padding: '15px', boxShadow: 'var(--shadow-sm)', position: 'relative', overflow: 'hidden', transition: 'opacity 0.2s' },
  ...
  taskBtn: { padding: '7px 12px', background: 'var(--gold-pale)', border: '1px solid var(--gold-border)', borderRadius: 'var(--r-sm)', color: 'var(--gold)', fontSize: '0.78rem', fontWeight: '600', cursor: 'pointer', fontFamily: 'var(--ff-sans)', flexShrink: 0 },
  doneBanner: { background: 'var(--teal-pale)', border: '1px solid rgba(0,158,115,0.2)', borderRadius: 'var(--r-md)', padding: '18px', display: 'flex', alignItems: 'center', gap: '14px', marginBottom: '16px' },
  doneTitle: { fontFamily: 'var(--ff-serif)', fontSize: '1rem', fontWeight: '700', color: 'var(--teal)', marginBottom: '3px' },
  doneSub: { fontSize: '0.8rem', color: 'var(--ink-muted)' },
  weekCard: { background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 'var(--r-lg)', padding: '18px', boxShadow: 'var(--shadow-sm)' },
