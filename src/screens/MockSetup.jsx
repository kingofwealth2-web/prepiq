...
const s = {
  ...
  modeOpt: { display: 'flex', alignItems: 'center', gap: '14px', padding: '15px 16px', border: '1.5px solid var(--border-mid)', borderRadius: 'var(--r-md)', cursor: 'pointer', background: 'var(--surface-mid)', transition: 'all 0.15s' },
  ...
  selectEl: { padding: '10px 12px', background: 'var(--surface-mid)', border: '1.5px solid var(--border-mid)', borderRadius: 'var(--r-sm)', color: 'var(--ink)', fontSize: '0.86rem', fontFamily: 'var(--ff-sans)', cursor: 'pointer', outline: 'none' },
