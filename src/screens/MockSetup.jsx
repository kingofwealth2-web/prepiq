...
const s = {
  ...
  back: { background: 'transparent', border: 'none', color: 'var(--ink-muted)', cursor: 'pointer', fontSize: '0.84rem', fontFamily: 'var(--ff)', padding: '0', marginBottom: '16px', display: 'block' },
  logo: { fontFamily: 'var(--ff)', fontSize: '1.3rem', fontWeight: '700', color: 'var(--ink)', marginBottom: '16px' },
  em: { color: 'var(--accent-light)', fontStyle: 'italic' },
  heading: { fontFamily: 'var(--ff)', fontSize: '1.4rem', fontWeight: '700', color: 'var(--ink)', marginBottom: '4px' },
  ...
  modeOpt: { display: 'flex', alignItems: 'center', gap: '14px', padding: '15px 16px', border: '1.5px solid var(--border-mid)', borderRadius: 'var(--r-md)', cursor: 'pointer', background: 'var(--bg)', transition: 'all 0.15s' },
  modeOptSel: { borderColor: 'var(--accent-primary)', background: 'var(--accent-soft)' },
  modeDot: { width: '17px', height: '17px', borderRadius: '50%', border: '2px solid var(--border-mid)', flexShrink: 0, transition: 'all 0.15s' },
  modeDotSel: { background: 'var(--accent-primary)', borderColor: 'var(--accent-primary)' },
  modeLabel: { fontSize: '0.9rem', fontWeight: '600', color: 'var(--ink)', marginBottom: '2px' },
  modeDesc: { fontSize: '0.76rem', color: 'var(--ink-muted)' },
  premBadge: { background: 'var(--accent-soft)', color: 'var(--accent-primary)', padding: '2px 7px', borderRadius: '20px', fontSize: '0.67rem', fontWeight: '600', marginLeft: '6px' },
