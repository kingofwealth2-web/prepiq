...
const s = {
  ...
  weakTitle: { fontFamily: 'var(--ff)', fontSize: '1rem', fontWeight: '700', color: 'var(--ink)', marginBottom: '16px' },
  weakList: { display: 'flex', flexDirection: 'column', gap: '10px', marginBottom: '16px' },
  weakItem: { display: 'flex', alignItems: 'center', gap: '12px' },
  weakName: { fontSize: '0.84rem', color: 'var(--ink)', width: '140px', flexShrink: 0 },
  ...
  bottomBtnPrimary: { flex: 1, padding: '11px', background: 'var(--surface-solid)', border: 'none', borderRadius: 'var(--r-sm)', color: 'var(--ink)', fontWeight: '600', fontSize: '0.84rem', cursor: 'pointer', fontFamily: 'var(--ff)' },
}
