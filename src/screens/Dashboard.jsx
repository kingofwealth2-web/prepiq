          ...
          <div style={s.dashGrid}>
            <div style={s.dashCard}>
              ...
              <div style={s.emptyState}>
                ...
                <div style={s.emptySubtext}>Take a mock exam to generate your plan</div>
              </div>
              <button style={s.btnGold} onClick={() => navigate('/practice')}>Start practicing</button>
            </div>
            <div style={s.dashCard}>
              <div style={s.dashCardHeader}>
...
const s = {
  ...
  actionBtn: { display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '6px', padding: '16px 10px', background: '#1C2330', border: '1px solid rgba(240,246,252,0.06)', borderRadius: '10px', cursor: 'pointer', fontFamily: 'DM Sans, sans-serif' },
