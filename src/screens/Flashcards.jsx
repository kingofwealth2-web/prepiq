...
const s = {
  ...
  subjectCard: { background: '#fff', border: '1px solid var(--border)', borderRadius: 'var(--r-lg)', padding: '20px', cursor: 'pointer', textAlign: 'center', boxShadow: 'var(--shadow-sm)', transition: 'box-shadow 0.15s' },
  ...
  generatingCard: { background: '#fff', border: '1px solid var(--border)', borderRadius: 'var(--r-xl)', padding: '48px', textAlign: 'center', maxWidth: '380px', position: 'relative', overflow: 'hidden', boxShadow: 'var(--shadow-md)' },
  ...
  flashCardFront: { position: 'absolute', inset: 0, background: '#fff', border: '1px solid var(--border)', borderRadius: 'var(--r-xl)', padding: '32px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', backfaceVisibility: 'hidden', WebkitBackfaceVisibility: 'hidden', boxShadow: 'var(--shadow-md)' },
  ...
  cardTopic: { fontSize: '0.72rem', color: 'var(--ink-muted)', marginBottom: '14px', background: 'var(--cream)', padding: '3px 10px', borderRadius: '20px' },
  ...
  finishedCard: { background: '#fff', border: '1px solid var(--border)', borderRadius: 'var(--r-xl)', padding: '40px', textAlign: 'center', maxWidth: '420px', width: '100%', position: 'relative', overflow: 'hidden', boxShadow: 'var(--shadow-md)' },
