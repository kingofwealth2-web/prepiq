      ...
      <main style={s.main}>
        ...
        <div style={s.content}>
          ...
          <div style={s.filterRow}>
            <select style={s.select} value={filters.subject}
            ...
            <select style={s.select} value={filters.year}
            ...
            <select style={s.select} value={filters.difficulty}
            ...
            {(filters.subject || filters.year || filters.type || filters.difficulty) && (
              <button style={s.clearBtn}
                onClick={() => setFilters({ subject:'', year:'', type:'', difficulty:'' })}>
                Clear filters
              </button>
            )}
          </div>
                  ...
                  <div style={s.qItemBody}>
                    <div style={s.qItemMeta}>
                      ...
                      {q.difficulty && <span style={{
                        ...s.badgeDiff,
                        background: q.difficulty === 'easy' ? 'rgba(0,200,150,0.1)' : q.difficulty === 'hard' ? 'rgba(255,107,107,0.1)' : 'rgba(240,165,0,0.1)',
...
const s = {
  ...
  backBtn: { background:'transparent', border:'none', color:'#8B949E', cursor:'pointer', fontSize:'0.85rem', fontFamily:'DM Sans, sans-serif', padding:'8px 12px' },
  ...
  skeleton: { height:'80px', background:'#161B22', borderRadius:'10px', animation:'pulse 1.5s infinite' },
