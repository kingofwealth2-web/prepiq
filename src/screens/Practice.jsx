...
const s = {
  ...
  modeToggle: { display: 'flex', background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 'var(--r-md)', padding: '4px', marginBottom: '18px', width: 'fit-content', gap: '3px' },
  ...
  select: { padding: '8px 12px', background: 'var(--surface)', border: '1.5px solid var(--border-mid)', borderRadius: 'var(--r-sm)', color: 'var(--ink)', fontSize: '0.84rem', fontFamily: 'var(--ff-sans)', cursor: 'pointer', outline: 'none', width: 'auto' },
  ...
  aiPanel: { background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 'var(--r-lg)', padding: '20px', marginBottom: '20px', position: 'relative', overflow: 'hidden', boxShadow: 'var(--shadow-sm)' },
  ...
  qItem: { display: 'flex', alignItems: 'center', gap: '14px', background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 'var(--r-md)', padding: '15px 18px', cursor: 'pointer', transition: 'box-shadow 0.15s', boxShadow: 'var(--shadow-sm)' },
  qItemBody: { flex: 1 },
