...
const s = {
  shell: { minHeight: '100vh', background: 'var(--bg)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px', fontFamily: 'var(--ff)' },
  card: { background: 'var(--surface-solid)', border: '1px solid var(--border)', borderRadius: 'var(--r-xl)', padding: '40px', width: '100%', maxWidth: '500px', boxShadow: 'none', position: 'relative', overflow: 'hidden' },
  ...
  logo: { fontFamily: 'var(--ff)', fontSize: '1.4rem', fontWeight: '700', color: 'var(--ink)', marginBottom: '24px' },
  em: { color: 'var(--accent-light)', fontStyle: 'italic' },
  progressRow: { marginBottom: '28px' },
  stepLabel: { fontSize: '0.68rem', fontWeight: '600', letterSpacing: '0.12em', textTransform: 'uppercase', color: 'var(--accent-primary)', marginBottom: '8px' },
  progressTrack: { height: '3px', background: 'rgba(255,255,255,.06)', borderRadius: '2px', overflow: 'hidden' },
  progressFill: { height: '100%', background: 'var(--accent-primary)', borderRadius: '2px', transition: 'width 0.4s ease' },
  heading: { fontFamily: 'var(--ff)', fontSize: '1.3rem', fontWeight: '700', color: 'var(--ink)', marginBottom: '6px' },
  ...
  option: { display: 'flex', alignItems: 'center', gap: '14px', padding: '15px 16px', border: '1.5px solid var(--border-mid)', borderRadius: 'var(--r-md)', cursor: 'pointer', transition: 'all 0.15s', background: 'var(--bg)' },
  optionSel: { borderColor: 'var(--accent-primary)', background: 'var(--accent-soft)' },
  ...
  chip: { padding: '6px 13px', borderRadius: '20px', border: '1.5px solid var(--border-mid)', background: 'var(--bg)', color: 'var(--ink-muted)', fontSize: '0.8rem', fontWeight: '500', cursor: 'pointer', transition: 'all 0.15s' },
  chipSel: { borderColor: 'var(--accent-primary)', background: 'var(--accent-soft)', color: 'var(--accent-primary)' },
  ...
  countdownCard: { background: 'var(--surface-solid)', border: '1px solid rgba(200,136,10,0.2)', borderRadius: 'var(--r-md)', padding: '20px', textAlign: 'center', marginBottom: '22px' },
  ...
  countdownNum: { fontFamily: 'var(--ff)', fontSize: '3.5rem', fontWeight: '700', color: 'var(--accent-light)', lineHeight: 1 },
  countdownSub: { fontSize: '0.78rem', color: 'rgba(247,243,238,0.5)', marginTop: '8px' },
  btnRow: { display: 'flex', gap: '10px' },
  btnPrimary: { flex: 1, padding: '13px', background: 'var(--surface-solid)', border: 'none', borderRadius: 'var(--r-sm)', color: '#F7F3EE', fontWeight: '600', fontSize: '0.9rem', cursor: 'pointer', fontFamily: 'var(--ff)', transition: 'opacity 0.15s' },
