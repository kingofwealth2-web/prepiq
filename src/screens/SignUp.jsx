  ...
  return (
    <div style={styles.shell}>
      <div style={styles.card}>
        ...
        <h2 style={styles.heading}>Join PrepIQ</h2>
        <p style={styles.sub}>Your WASSCE & BECE study companion.</p>
        {error && <div style={styles.error}>{error}</div>}
        <form onSubmit={handleSubmit} style={styles.form}>
          <div style={styles.group}>
            <label style={styles.fieldLabel}>Full name</label>
            <input style={styles.input} name="full_name" placeholder="e.g. Kwame Mensah"
        ...
        <p style={styles.switch}>Already have an account? <Link to="/login" style={styles.link}>Log in</Link></p>
      </div>
      <div style={styles.right}>
        <div style={styles.rightInner}>
          <div style={styles.bigText}>Your exam.<br /><em style={styles.gold}>Your edge.</em></div>
          <p style={styles.rightSub}>PrepIQ analyses years of WAEC patterns to tell you exactly what to study next.</p>
          <div style={styles.stats}>
            <div style={styles.stat}><div style={styles.statNum}>50K+</div><div style={styles.statLabel}>Questions</div></div>
            <div style={styles.stat}><div style={styles.statNum}>20yrs</div><div style={styles.statLabel}>Past papers</div></div>
            <div style={styles.stat}><div style={styles.statNum}>3</div><div style={styles.statLabel}>Exams covered</div></div>
          </div>
        </div>
      </div>
    </div>
...
const styles = {
  ...
  orLine: { textAlign:'center', color:'#484F58', fontSize:'0.82rem', margin:'16px 0', position:'relative' },
  ...
  rightSub: { fontSize:'1rem', color:'#8B949E', marginBottom:'32px' },
  stats: { display:'flex', gap:'32px' },
  stat: { textAlign:'center' },
  statNum: { fontSize:'1.8rem', fontWeight:'700', color:'#F0A500', fontFamily:'Georgia, serif' },
