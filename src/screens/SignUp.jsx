...
export default function SignUp() {
  ...
  const fields = [
    ['full_name', 'Full name', 'text', 'e.g. Kwame Mensah', undefined],
    ['email', 'Email', 'email', 'you@gmail.com', undefined],
    ['password', 'Password', 'password', 'Min. 8 characters', 8],
  ]
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ width: '100%', maxWidth: '360px', animation: 'fadeUp 0.4s ease both' }}>
          ...
          <div style={{ fontSize: '0.65rem', fontWeight: '600', letterSpacing: '0.14em', textTransform: 'uppercase', color: theme.light, marginBottom: '6px' }}>Create account</div>
          <h2 style={{ fontSize: '1.5rem', fontWeight: '800', color: 'var(--ink)', letterSpacing: '-0.03em', marginBottom: '6px' }}>Join PrepIQ today</h2>
          <p style={{ fontSize: '0.86rem', color: 'var(--ink-muted)', marginBottom: '24px' }}>Your WASSCE, BECE & University study companion.</p>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '14px', marginBottom: '16px' }}>
            {fields.map(([name, lbl, type, ph, minLen]) => (
          ...
          <p style={{ textAlign: 'center', fontSize: '0.82rem', color: 'var(--ink-muted)', marginTop: '20px' }}>
            ...
            <Link to="/login" style={{ color: theme.light, fontWeight: '600', textDecoration: 'none' }}>Log in</Link>
          </p>
        </div>
      </div>
        ...
        <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '60px' }}>
          <div style={{ maxWidth: '420px' }}>
            <div style={{ fontSize: '3.4rem', fontWeight: '800', color: 'var(--ink)', lineHeight: 1.05, marginBottom: '20px', letterSpacing: '-0.04em' }}>
              Your exam.<br /><em style={{ color: theme.light, fontStyle: 'italic' }}>Your edge.</em>
            </div>
            <p style={{ fontSize: '1rem', color: 'var(--ink-muted)', marginBottom: '36px', lineHeight: 1.6 }}>
              PrepIQ analyses years of WAEC patterns to tell you exactly what to study next.
            </p>
