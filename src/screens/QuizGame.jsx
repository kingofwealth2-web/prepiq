...
const s = {
  shell: { minHeight: '100vh', background: 'var(--cream)', fontFamily: 'var(--ff-sans)', display: 'flex', flexDirection: 'column', position: 'relative' },
  header: { background: '#fff', borderBottom: '1px solid var(--border)' },
  ...
  setupCard: { background: '#fff', border: '1px solid var(--border)', borderRadius: 'var(--r-xl)', padding: '36px', maxWidth: '460px', width: '100%', textAlign: 'center', position: 'relative', overflow: 'hidden', boxShadow: 'var(--shadow-md)' },
  ...
  subjectOpt: { display: 'flex', alignItems: 'center', gap: '12px', padding: '11px 15px', border: '1.5px solid var(--border-mid)', borderRadius: 'var(--r-md)', cursor: 'pointer', transition: 'all 0.15s', background: 'var(--cream)' },
  ...
  gameTopbar: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '12px 24px', background: '#fff', borderBottom: '1px solid var(--border)' },
  ...
  questionCard: { background: '#fff', border: '1px solid var(--border)', borderRadius: 'var(--r-lg)', padding: '22px', marginBottom: '14px', boxShadow: 'var(--shadow-sm)' },
  ...
  gameOption: { display: 'flex', alignItems: 'center', gap: '10px', background: '#fff', border: '2px solid var(--border)', borderRadius: 'var(--r-md)', padding: '13px 15px', cursor: 'pointer', transition: 'all 0.12s', boxShadow: 'var(--shadow-sm)' },
  ...
  gameOptLetter: { width: '28px', height: '28px', borderRadius: '50%', background: 'var(--cream)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '0.76rem', fontWeight: '700', color: 'var(--ink-muted)', flexShrink: 0 },
  ...
  resultItem: { display: 'flex', alignItems: 'center', gap: '10px', background: '#fff', borderLeft: '3px solid', border: '1px solid var(--border)', borderRadius: 'var(--r-sm)', padding: '10px 14px', boxShadow: 'var(--shadow-sm)' },
