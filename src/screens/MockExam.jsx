...
const s = {
  ...
  topbar: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '14px 24px', background: 'var(--surface)', borderBottom: '1px solid var(--border)' },
  ...
  pills: { display: 'flex', gap: '5px', padding: '12px 24px', background: 'var(--surface)', borderBottom: '1px solid var(--border)', overflowX: 'auto', flexWrap: 'wrap' },
  ...
  pillAnswered: { background: 'var(--teal)', borderColor: 'var(--teal)', color: 'var(--surface)' },
